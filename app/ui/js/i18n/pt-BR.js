...
(window.I18N || (window.I18N = {}))["pt-BR"] = {
  ...
  UI_TOGGLE_PANEL: "Recolher ou mostrar o painel (Ctrl+B)",
  ...
  ERROR_CONNECTION_EXISTS_SUGGEST: "Já existe uma conexão chamada '{name}'. Sugeri '{suggestion}' — confira e clique em Adicionar.",
  ...
  UI_MENU_CONNECTION_EDIT: "Propriedades da conexão",
  UI_EDIT_CONNECTION_TITLE: "Propriedades da conexão",
  ...
  INFO_CODEPAGE_UNPINNED: "Codepage do arquivo desfixado; volta a valer o da conexão ou o global.",
  INFO_CONFIG_SAVED: "Preferências salvas.",
  INFO_CONNECTION_UPDATED: "Conexão '{name}' atualizada.",
  ERROR_CONNECTION_NAME_EMPTY: "A conexão precisa de um nome.",
  INFO_CONNECTION_DETACHED_TABS: {
    one: "Uma aba deixou de pertencer a ela.",
    other: "{n} abas deixaram de pertencer a ela.",
  },
  WARN_CODEPAGE_NOT_PINNED: "Não foi possível gravar na pasta; o codepage {cp} vale só nesta sessão.",
  WARN_CODEPAGE_NOT_UNPINNED: "Não foi possível gravar na pasta; o codepage continua fixado no arquivo.",
  ...
  UI_FN_YEAR_KW: "ano",
  // ---------------------------------------------------- IA do construtor
  UI_IA_SECTION: "Assistente de expressões (IA)",
  UI_IA_ENDPOINT: "Endereço do serviço",
  UI_IA_MODEL: "Modelo",
  UI_IA_KEY: "Chave da API",
  UI_IA_KEY_PH: "cole a chave aqui; deixe vazio para manter; \"-\" para apagar",
  UI_IA_KEY_SET: "(configurada)",
  ...
  UI_IA_QUESTION: "O assistente pergunta: {q}",
  UI_IA_NO_RESULT: "O assistente não conseguiu montar a expressão.",
  UI_IA_NO_RESULT_WHY: "O assistente não conseguiu: {why}",
  ERROR_IA_FAILED: "O assistente não respondeu: {detail}",
  ERROR_IA_CONFIG: "Não deu para gravar a configuração do assistente: {detail}",
  UI_IA_AVISO_TITLE: "Antes de usar o assistente",
  UI_IA_AVISO_1: "O seu pedido, os nomes e os tipos dos campos deste arquivo, e a lista de funções serão enviados ao serviço configurado em Preferências. Nenhum registro do arquivo é enviado.",
  UI_IA_AVISO_2: "Este programa não guarda nada do que é enviado nem do que volta. O que o serviço faz com isso é entre você e ele.",
  UI_IA_AVISO_3: "O que voltar é uma sugestão: nada é aplicado sem você conferir e clicar em Usar. E, como sempre, tenha backup antes de gravar num arquivo.",
  UI_IA_AVISO_NO_MORE: "Não mostrar mais este aviso",
  UI_IA_AVISO_OK: "Entendi, continuar",
};
