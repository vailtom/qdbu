...
(window.I18N || (window.I18N = {}))["pt-BR"] = {
  ...
  UI_FILE_IN_USE_TITLE: "Arquivo em uso",
  ...
  WARN_STRUCTURE_CANCELLED_LOST: "Alteração de estrutura cancelada. Nada foi alterado, mas o arquivo saiu da sessão e o rascunho não pôde voltar.",
  WARN_TAB_CHANGED: "A aba mudou enquanto o arquivo era conferido. Repita na aba que você quer.",
  WARN_PACK_CANCELLED: "Compactação cancelada. Nada foi alterado.",
  WARN_ZAP_CANCELLED: "Esvaziamento cancelado. Nada foi alterado.",
  ...
  ERROR_RENAME_FAILED:
    "Não foi possível colocar o arquivo novo no lugar de '{file}' — outro programa pegou o arquivo no último passo. O original continua lá, e a cópia também.",
  ...
  UI_SYNC_TITLE: "Sincronizar estrutura",
  UI_MENU_SYNC: "Sincronizar estrutura…",
  UI_SYNC_EXPLAIN: "Compara os DBFs de uma pasta de referência com os da pasta alvo e deixa o alvo com a mesma estrutura, arquivo a arquivo. Cada arquivo é uma operação com a própria cópia; os dados passam pelo nome do campo, nunca pela posição.",
  UI_SYNC_SOURCE: "Referência (de onde vem a estrutura)",
  UI_SYNC_TARGET: "Alvo (a pasta que vai mudar)",
  UI_SYNC_SWAP: "Trocar referência e alvo",
  UI_SYNC_PICK: "escolha…",
  UI_SYNC_OTHER_FOLDER: "outra pasta…",
  UI_SYNC_PICK_TITLE_SOURCE: "Pasta de referência",
  UI_SYNC_PICK_TITLE_TARGET: "Pasta alvo",
  UI_SYNC_BY_POSITION: "Considerar a ordem dos campos como diferença",
  UI_SYNC_COMPARE: "Comparar",
  UI_SYNC_COMPARING: "comparando…",
  UI_SYNC_FILES: "Arquivos",
  UI_SYNC_SEARCH_PH: "procurar arquivo…",
  UI_SYNC_MARK_ALL: "Todos",
  UI_SYNC_MARK_NONE: "Nenhum",
  UI_SYNC_MARK_TITLE: "Entra no \"Aplicar marcados\"",
  UI_SYNC_ONLY_DIFF: "só diferenças",
  UI_SYNC_NO_COMPARE_YET: "Escolha a referência e o alvo e clique em Comparar.",
  UI_SYNC_NO_FILES: "Nenhum arquivo nesta lista.",
  UI_SYNC_FIELDS_TITLE: "Campos de {file}",
  UI_SYNC_FIELDS_TITLE_NONE: "Campos",
  UI_SYNC_PICK_FILE: "Escolha um arquivo à esquerda para ver os campos.",
  UI_SYNC_SAME_TXT: "Estrutura idêntica à referência. Nada a fazer.",
  UI_SYNC_ONLY_TARGET_TXT: "Existe só no alvo. Nada será feito com ele — o QDbu não apaga arquivos.",
  UI_SYNC_IN_USE_TXT: "Em uso por outro programa ({side}); a estrutura não pôde ser lida agora.",
  UI_SYNC_INVALID_TXT: "Não é um DBF válido ({side}): {reason}",
  UI_SYNC_SIDE_source: "na referência",
  UI_SYNC_SIDE_target: "no alvo",
  UI_SYNC_KIND_novo: "campo novo",
  UI_SYNC_COPY_DATA: { one: "Copiar também o {n} registro da referência", other: "Copiar também os {n} registros da referência" },
  UI_SYNC_COPY_NONE: "A tabela de referência está vazia — não há dados a copiar.",
  UI_SYNC_COPY_WARN: "Os dados vêm da pasta de referência. Vale para tabela de domínio (bancos, NCM, CFOP, municípios); pense duas vezes se for movimento de outro cliente.",
  UI_SYNC_CREATE_EMPTY: "criada vazia",
  UI_SYNC_CREATE_WITH_DATA: { one: "criada com {n} registro copiado", other: "criada com {n} registros copiados" },
  UI_SYNC_WITH_DATA_COUNT: { one: "{n} com dados", other: "{n} com dados" },
  UI_SYNC_WITH_DATA_TITLE: "Será criada com os dados da referência",
  UI_SYNC_VIEW_DIFF: "só as diferenças",
  UI_SYNC_VIEW_ALL: "todos os campos",
  UI_SYNC_VIEW_SAME: "os que conferem",
  UI_SYNC_VIEW_COUNT: "{n} de {total}",
  UI_SYNC_NO_FIELDS_IN_VIEW: "Nenhum campo nesta visão.",
  UI_SYNC_FIELD_SAME: "confere",
  UI_SYNC_STATUS_same: "igual",
  UI_SYNC_STATUS_differs: "difere",
  UI_SYNC_STATUS_missingInTarget: "não existe",
  UI_SYNC_STATUS_onlyInTarget: "só no alvo",
  UI_SYNC_STATUS_inUse: "em uso",
  UI_SYNC_STATUS_invalid: "inválido",
  UI_SYNC_KIND_missing: "não existe no alvo",
  UI_SYNC_KIND_extra: "só existe no alvo",
  UI_SYNC_KIND_type: "tipo diferente",
  UI_SYNC_KIND_len: "tamanho diferente",
  UI_SYNC_KIND_dec: "decimais diferentes",
  UI_SYNC_KIND_position: "fora de posição",
  UI_SYNC_COL_POS: "Nº",
  UI_SYNC_COL_FIELD: "Campo",
  UI_SYNC_COL_REF: "Referência",
  UI_SYNC_COL_TARGET: "Alvo",
  UI_SYNC_COL_WHAT: "O que difere",
  UI_SYNC_COL_CHOICE: "Decisão",
  UI_SYNC_AUTO_CREATE: "será criado em branco",
  UI_SYNC_AUTO_MOVE: "só muda de lugar",
  UI_SYNC_KEEP: "Ignorar",
  UI_SYNC_ADOPT: "Atualizar",
  UI_SYNC_DROP: "Remover",
  UI_SYNC_ALL_THIS_FILE: "em {file}:",
  UI_SYNC_ALL_FILES: "em todos os arquivos:",
  UI_SYNC_BULK_DONE: { one: "{n} campo decidido.", other: "{n} campos decididos." },
  UI_SYNC_BULK_DONE_ALL: { one: "{n} campo decidido na lista inteira.", other: "{n} campos decididos na lista inteira." },
  UI_SYNC_BULK_NONE: "Nada a decidir aqui: nenhum campo pede escolha — só ordem e campo novo, que não perdem dado.",
  UI_SYNC_SUMMARY: "{differs} a alterar · {create} a criar · {same} iguais · {only} só no alvo · {busy} em uso/inválidos",
  UI_SYNC_PENDING: { one: "{n} campo sem decisão", other: "{n} campos sem decisão" },
  UI_SYNC_APPLY_ONE: "Aplicar este",
  UI_SYNC_APPLY_MARKED: { one: "Aplicar {n} marcado", other: "Aplicar {n} marcados" },
  UI_SYNC_APPLY_TITLE: "Aplicar a estrutura da referência",
  UI_SYNC_APPLY_ASK: { one: "{n} arquivo do alvo será alterado ou criado com a estrutura da referência. É uma operação separada, com a própria cópia; os dados passam pelo nome do campo.", other: "{n} arquivos do alvo serão alterados ou criados com a estrutura da referência. Cada um é uma operação separada, com a própria cópia; os dados passam pelo nome do campo." },
  UI_SYNC_APPLY_ASK_CREATE: { one: "{n} tabela será criada VAZIA no alvo, com a estrutura da referência. Nenhum arquivo existente é tocado.", other: "{n} tabelas serão criadas VAZIAS no alvo, com a estrutura da referência. Nenhum arquivo existente é tocado." },
  UI_SYNC_APPLY_ASK_CREATE_DATA: { one: "{n} tabela será criada no alvo com a estrutura da referência. Nenhum arquivo existente é tocado; veja abaixo quais levam os dados junto.", other: "{n} tabelas serão criadas no alvo com a estrutura da referência. Nenhum arquivo existente é tocado; veja abaixo quais levam os dados junto." },
  UI_SYNC_APPLY_CONFIRM: "Aplicar",
  UI_SYNC_LOSS_shrink: "{field} encolhe — o que não couber é cortado",
  UI_SYNC_LOSS_type: "{field} muda de tipo — o que não converter fica vazio",
  UI_SYNC_LOSS_dec: "{field} perde casas decimais",
  UI_SYNC_LOSS_drop: "{field} é removido — os dados dessa coluna são perdidos",
  UI_SYNC_WORKING: "aplicando em {file}…",
  UI_SYNC_STOPPING: "Parando depois do arquivo atual…",
  UI_SYNC_RESULT_TITLE: "Sincronização concluída",
  UI_SYNC_RESULT_ok: "{file}: feito",
  UI_SYNC_RESULT_fail: "{file}: falhou — {detail}",
  UI_SYNC_RESULT_stop: "{file}: não executado (parado)",
  UI_SYNC_RESULT_skip: "{file}: nada a fazer",
  INFO_SYNC_DONE: "Sincronização: {ok} feito(s), {fail} falha(s).",
  WARN_SYNC_SKIPPED: "Pulado a pedido.",
  ERROR_SYNC_NEED_BOTH: "Escolha a referência e o alvo.",
  ERROR_SYNC_SAME_DIR: "Referência e alvo são a mesma pasta: {dir}",
  ERROR_SYNC_CHOICE_MISSING: "O campo {field} ainda não tem decisão (manter ou adotar).",
  ERROR_SYNC_CHOICE_INVALID: "Decisão inválida para {field}: {choice}.",
  ...
  UI_USE: "Usar",
  UI_IA_LIST: "Escolher…",
  UI_IA_LIST_TITLE: "Perguntar ao serviço quais modelos ele oferece e escolher um da lista",
  UI_IA_LISTING: "buscando…",
  UI_IA_PICK_MODEL: "Escolha o modelo",
  UI_IA_SEARCH_PH: "procurar pelo nome…",
  UI_IA_NO_MATCH: "Nenhum modelo com esse nome.",
  UI_IA_PICK_EXPLAIN: { one: "O serviço ofereceu {n} modelo. Os mais indicados para escrever expressões estão no topo; os demais continuam na lista.", other: "O serviço ofereceu {n} modelos. Os mais indicados para escrever expressões estão no topo; os demais continuam na lista." },
  UI_IA_MODELS_SUGGESTED: "Mais indicados",
  UI_IA_MODELS_OTHERS: "Os demais que o serviço oferece",
