...
(window.I18N || (window.I18N = {}))["pt-BR"] = {
  ...
  UI_CX_OK_VALUE: "✓ compila · {type} · no registro {n} vale {value}",
  UI_CX_VALUE_LEN: "{value} ({len} de {max})",
  UI_CX_WRONG_TYPE: "✗ Esperava {expected} — isto devolve {got}.",
  ...
  UI_CX_MORE: "Mais",
  UI_CX_LESS: "Menos",
  UI_CX_SEARCH: "buscar campo, função ou operador — em português, inglês ou espanhol",
