...
(window.I18N || (window.I18N = {}))["es"] = {
  ...
  UI_CREATE: "Crear",
  UI_CANCEL: "Cancelar",
  UI_RETRY: "Intentar de nuevo",
  UI_FILE_IN_USE_TITLE: "Archivo en uso",
  ...
  UI_CONN_MODE: "Modo de apertura predeterminado",
  UI_CONN_MODE_EXPLAIN: "Vale para todo archivo abierto por esta conexión. La ventana Abrir archivo sigue decidiendo caso por caso.",
  UI_CDP_INHERIT: "(heredar)",
  UI_MENU_CONNECTION_EDIT: "Propiedades de la conexión",
  UI_EDIT_CONNECTION_TITLE: "Propiedades de la conexión",
  ...
  UI_SYNC_TITLE: "Sincronizar estructura",
  UI_MENU_SYNC: "Sincronizar estructura…",
  UI_SYNC_EXPLAIN: "Compara los DBF de una carpeta de referencia con los de la carpeta destino y deja el destino con la misma estructura, archivo por archivo. Cada archivo es una operación con su propia copia; los datos viajan por el nombre del campo, nunca por la posición.",
  UI_SYNC_SOURCE: "Referencia (de dónde viene la estructura)",
  UI_SYNC_TARGET: "Destino (la carpeta que va a cambiar)",
  UI_SYNC_SWAP: "Intercambiar referencia y destino",
  UI_SYNC_PICK: "elija…",
  UI_SYNC_OTHER_FOLDER: "otra carpeta…",
  UI_SYNC_PICK_TITLE_SOURCE: "Carpeta de referencia",
  UI_SYNC_PICK_TITLE_TARGET: "Carpeta destino",
  UI_SYNC_BY_POSITION: "Considerar el orden de los campos como diferencia",
  UI_SYNC_COMPARE: "Comparar",
  UI_SYNC_COMPARING: "comparando…",
  UI_SYNC_FILES: "Archivos",
  UI_SYNC_SEARCH_PH: "buscar archivo…",
  UI_SYNC_MARK_ALL: "Todos",
  UI_SYNC_MARK_NONE: "Ninguno",
  UI_SYNC_MARK_TITLE: "Entra en \"Aplicar marcados\"",
  UI_SYNC_ONLY_DIFF: "solo diferencias",
  UI_SYNC_NO_COMPARE_YET: "Elija la referencia y el destino y pulse Comparar.",
  UI_SYNC_NO_FILES: "Ningún archivo en esta lista.",
  UI_SYNC_FIELDS_TITLE: "Campos de {file}",
  UI_SYNC_FIELDS_TITLE_NONE: "Campos",
  UI_SYNC_PICK_FILE: "Elija un archivo a la izquierda para ver los campos.",
  UI_SYNC_SAME_TXT: "Estructura idéntica a la referencia. Nada que hacer.",
  UI_SYNC_ONLY_TARGET_TXT: "Existe solo en el destino. No se hará nada con él: QDbu no borra archivos.",
  UI_SYNC_IN_USE_TXT: "En uso por otro programa ({side}); la estructura no pudo leerse ahora.",
  UI_SYNC_INVALID_TXT: "No es un DBF válido ({side}): {reason}",
  UI_SYNC_SIDE_source: "en la referencia",
  UI_SYNC_SIDE_target: "en el destino",
  UI_SYNC_KIND_novo: "campo nuevo",
  UI_SYNC_COPY_DATA: { one: "Copiar también el {n} registro de la referencia", other: "Copiar también los {n} registros de la referencia" },
  UI_SYNC_COPY_NONE: "La tabla de referencia está vacía — no hay datos que copiar.",
  UI_SYNC_COPY_WARN: "Los datos vienen de la carpeta de referencia. Sirve para tablas de dominio (bancos, NCM, CFOP, municipios); piénselo dos veces si es movimiento de otro cliente.",
  UI_SYNC_CREATE_EMPTY: "creada vacía",
  UI_SYNC_CREATE_WITH_DATA: { one: "creada con {n} registro copiado", other: "creada con {n} registros copiados" },
  UI_SYNC_WITH_DATA_COUNT: { one: "{n} con datos", other: "{n} con datos" },
  UI_SYNC_WITH_DATA_TITLE: "Se creará con los datos de la referencia",
  UI_SYNC_VIEW_DIFF: "solo las diferencias",
  UI_SYNC_VIEW_ALL: "todos los campos",
  UI_SYNC_VIEW_SAME: "los que coinciden",
  UI_SYNC_VIEW_COUNT: "{n} de {total}",
  UI_SYNC_NO_FIELDS_IN_VIEW: "Ningún campo en esta vista.",
  UI_SYNC_FIELD_SAME: "coincide",
  UI_SYNC_STATUS_same: "igual",
  UI_SYNC_STATUS_differs: "difiere",
  UI_SYNC_STATUS_missingInTarget: "no existe",
  UI_SYNC_STATUS_onlyInTarget: "solo en destino",
  UI_SYNC_STATUS_inUse: "en uso",
  UI_SYNC_STATUS_invalid: "inválido",
  UI_SYNC_KIND_missing: "no existe en el destino",
  UI_SYNC_KIND_extra: "solo existe en el destino",
  UI_SYNC_KIND_type: "tipo diferente",
  UI_SYNC_KIND_len: "tamaño diferente",
  UI_SYNC_KIND_dec: "decimales diferentes",
  UI_SYNC_KIND_position: "fuera de posición",
  UI_SYNC_COL_POS: "Nº",
  UI_SYNC_COL_FIELD: "Campo",
  UI_SYNC_COL_REF: "Referencia",
  UI_SYNC_COL_TARGET: "Destino",
  UI_SYNC_COL_WHAT: "Qué difiere",
  UI_SYNC_COL_CHOICE: "Decisión",
  UI_SYNC_AUTO_CREATE: "se creará en blanco",
  UI_SYNC_AUTO_MOVE: "solo cambia de lugar",
  UI_SYNC_KEEP: "Ignorar",
  UI_SYNC_ADOPT: "Actualizar",
  UI_SYNC_DROP: "Quitar",
  UI_SYNC_ALL_THIS_FILE: "en {file}:",
  UI_SYNC_ALL_FILES: "en todos los archivos:",
  UI_SYNC_BULK_DONE: { one: "{n} campo decidido.", other: "{n} campos decididos." },
  UI_SYNC_BULK_DONE_ALL: { one: "{n} campo decidido en toda la lista.", other: "{n} campos decididos en toda la lista." },
  UI_SYNC_BULK_NONE: "Nada que decidir aquí: ningún campo pide elección — solo orden y campos nuevos, que no pierden datos.",
  UI_SYNC_SUMMARY: "{differs} a cambiar · {create} a crear · {same} iguales · {only} solo en destino · {busy} en uso/inválidos",
  UI_SYNC_PENDING: { one: "{n} campo sin decisión", other: "{n} campos sin decisión" },
  UI_SYNC_APPLY_ONE: "Aplicar este",
  UI_SYNC_APPLY_MARKED: { one: "Aplicar {n} marcado", other: "Aplicar {n} marcados" },
  UI_SYNC_APPLY_TITLE: "Aplicar la estructura de la referencia",
  UI_SYNC_APPLY_ASK: { one: "{n} archivo del destino se cambiará o creará con la estructura de la referencia. Es una operación separada, con su propia copia; los datos viajan por el nombre del campo.", other: "{n} archivos del destino se cambiarán o crearán con la estructura de la referencia. Cada uno es una operación separada, con su propia copia; los datos viajan por el nombre del campo." },
  UI_SYNC_APPLY_ASK_CREATE: { one: "{n} tabla se creará VACÍA en el destino, con la estructura de la referencia. Ningún archivo existente se toca.", other: "{n} tablas se crearán VACÍAS en el destino, con la estructura de la referencia. Ningún archivo existente se toca." },
  UI_SYNC_APPLY_ASK_CREATE_DATA: { one: "{n} tabla se creará en el destino con la estructura de la referencia. Ningún archivo existente se toca; vea abajo cuáles llevan los datos.", other: "{n} tablas se crearán en el destino con la estructura de la referencia. Ningún archivo existente se toca; vea abajo cuáles llevan los datos." },
  UI_SYNC_APPLY_CONFIRM: "Aplicar",
  UI_SYNC_LOSS_shrink: "{field} se encoge: lo que no quepa se corta",
  UI_SYNC_LOSS_type: "{field} cambia de tipo: lo que no convierta queda vacío",
  UI_SYNC_LOSS_dec: "{field} pierde decimales",
  UI_SYNC_LOSS_drop: "{field} se quita: los datos de esa columna se pierden",
  UI_SYNC_WORKING: "aplicando en {file}…",
  UI_SYNC_STOPPING: "Deteniendo tras el archivo actual…",
  UI_SYNC_RESULT_TITLE: "Sincronización terminada",
  UI_SYNC_RESULT_ok: "{file}: hecho",
  UI_SYNC_RESULT_fail: "{file}: falló — {detail}",
  UI_SYNC_RESULT_stop: "{file}: no ejecutado (detenido)",
  UI_SYNC_RESULT_skip: "{file}: nada que hacer",
  INFO_SYNC_DONE: "Sincronización: {ok} hecho(s), {fail} fallo(s).",
  WARN_SYNC_SKIPPED: "Omitido a pedido.",
  ERROR_SYNC_NEED_BOTH: "Elija la referencia y el destino.",
  ERROR_SYNC_SAME_DIR: "Referencia y destino son la misma carpeta: {dir}",
  ERROR_SYNC_CHOICE_MISSING: "El campo {field} aún no tiene decisión (mantener o adoptar).",
  ERROR_SYNC_CHOICE_INVALID: "Decisión inválida para {field}: {choice}.",

  // ---------------------------------------------------- asistente del constructor
  UI_IA_SECTION: "Asistente de expresiones (IA)",
  UI_IA_ENDPOINT: "Dirección del servicio",
  UI_IA_MODEL: "Modelo",
  UI_IA_KEY: "Clave de la API",
  UI_IA_KEY_PH: "pegue la clave aquí; deje vacío para mantenerla; \"-\" para borrarla",
  UI_USE: "Usar",
  UI_IA_LIST: "Elegir…",
  ...
  UI_IA_NEED_KEY_FIRST: "Escriba la clave de la API en el campo de arriba y pulse Elegir otra vez — es lo que permite preguntar al servicio qué modelos existen.",
  WARN_IA_NO_MODELS: "El servicio respondió pero no listó ningún modelo. Escriba el nombre del modelo en el campo.",
  INFO_IA_MODEL_PICKED: { one: "Modelo elegido: {model}. El servicio ofreció {n} modelo.", other: "Modelo elegido: {model}. El servicio ofreció {n} modelos." },
  ERROR_IA_KEY_REFUSED: "El servicio no aceptó esta clave. Compruebe que se copió entera, sin espacios de más. ({detail})",
  ERROR_IA_MODELS: "No se pudieron listar los modelos: {detail}",
  UI_IA_KEY_UNSET: "(no configurada)",
  UI_IA_KEY_BROKEN: "(archivo de configuración ilegible — informe la clave para recrearlo)",
  UI_IA_EXPLAIN: "Con la clave configurada, el botón ✦ del constructor de expresiones empieza a funcionar: usted describe lo que quiere y recibe la expresión lista. La dirección acepta cualquier servicio en formato \"chat completions\" — OpenAI, un Ollama local, un proxy de la empresa.",
  UI_IA_NO_KEY: "Para usar el asistente, informe la clave de la API en Preferencias (⚙). Usted describe con palabras la expresión que quiere y la recibe lista.",
  UI_IA_OPEN_PREFS: "Abrir Preferencias",
  UI_IA_ASK: "IA",
  UI_IA_ASK_TITLE: "Describir con palabras lo que la expresión debe hacer",
  ...
  UI_IA_QUESTION: "El asistente pregunta: {q}",
  UI_IA_NO_RESULT: "El asistente no pudo armar la expresión.",
  UI_IA_NO_RESULT_WHY: "El asistente no pudo: {why}",
  ERROR_IA_FAILED: "El asistente no respondió: {detail}",
  ERROR_IA_CONFIG: "No se pudo guardar la configuración del asistente: {detail}",
  UI_IA_AVISO_TITLE: "Antes de usar el asistente",
  UI_IA_AVISO_1: "Su pedido, los nombres y tipos de los campos de este archivo y la lista de funciones se enviarán al servicio configurado en Preferencias. No se envía ningún registro del archivo.",
  UI_IA_AVISO_2: "Este programa no guarda nada de lo que se envía ni de lo que vuelve. Lo que el servicio haga con eso es entre usted y el servicio.",
  UI_IA_AVISO_3: "Lo que vuelve es una sugerencia: nada se aplica hasta que usted lo revise y haga clic en Usar. Y, como siempre, tenga copia de seguridad antes de escribir en un archivo.",
  UI_IA_AVISO_NO_MORE: "No volver a mostrar este aviso",
  UI_IA_AVISO_OK: "Entendido, continuar",
};
