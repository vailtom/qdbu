...
(window.I18N || (window.I18N = {}))["es"] = {
  ...
  UI_CX_OK_VALUE: "✓ compila · {type} · en el registro {n} vale {value}",
  UI_CX_VALUE_LEN: "{value} ({len} de {max})",
  UI_CX_WRONG_TYPE: "✗ Esperaba {expected} — esto devuelve {got}.",
  UI_CX_NO_SYMBOL: "✗ No existe el campo o la función {symbol}.",
  UI_CX_SIMILAR: "Parecido: {name}.",
  UI_CX_NOT_COMPILE: "✗ {detail}",
  UI_CX_WARNING: "⚠ Compila, pero no se pudo evaluar en el registro {n}: {detail}",
  UI_CX_SIMPLIFY: "la condición ya es Lógica — funciona sin el IIf.",
  UI_CX_TRUE: "Sí",
  UI_CX_FALSE: "No",
