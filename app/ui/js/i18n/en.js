...
(window.I18N || (window.I18N = {}))["en"] = {
  ...
  UI_MENU_CONNECTION_EDIT: "Connection properties",
  UI_EDIT_CONNECTION_TITLE: "Connection properties",
  ...
  UI_FN_YEAR_KW: "year",
  // ---------------------------------------------------- structure sync
  UI_SYNC_TITLE: "Synchronize structure",
  UI_MENU_SYNC: "Synchronize structure…",
  UI_SYNC_EXPLAIN: "Compares the DBFs of a reference folder with those of the target folder and brings the target to the same structure, one file at a time. Each file is its own operation with its own copy; data travels by field name, never by position.",
  UI_SYNC_SOURCE: "Reference (where the structure comes from)",
  UI_SYNC_TARGET: "Target (the folder that will change)",
  UI_SYNC_SWAP: "Swap reference and target",
  UI_SYNC_PICK: "choose…",
  UI_SYNC_OTHER_FOLDER: "another folder…",
  UI_SYNC_PICK_TITLE_SOURCE: "Reference folder",
  UI_SYNC_PICK_TITLE_TARGET: "Target folder",
  UI_SYNC_BY_POSITION: "Treat field order as a difference",
  UI_SYNC_COMPARE: "Compare",
  UI_SYNC_COMPARING: "comparing…",
  UI_SYNC_FILES: "Files",
  UI_SYNC_SEARCH_PH: "find file…",
  UI_SYNC_MARK_ALL: "All",
  UI_SYNC_MARK_NONE: "None",
  UI_SYNC_MARK_TITLE: "Included in \"Apply marked\"",
  UI_SYNC_ONLY_DIFF: "differences only",
  UI_SYNC_NO_COMPARE_YET: "Choose the reference and the target and click Compare.",
  UI_SYNC_NO_FILES: "No files in this list.",
  UI_SYNC_FIELDS_TITLE: "Fields of {file}",
  UI_SYNC_FIELDS_TITLE_NONE: "Fields",
  UI_SYNC_PICK_FILE: "Pick a file on the left to see its fields.",
  UI_SYNC_SAME_TXT: "Structure identical to the reference. Nothing to do.",
  UI_SYNC_ONLY_TARGET_TXT: "Exists only in the target. Nothing will be done to it — QDbu does not delete files.",
  UI_SYNC_IN_USE_TXT: "In use by another program ({side}); its structure could not be read now.",
  UI_SYNC_INVALID_TXT: "Not a valid DBF ({side}): {reason}",
  UI_SYNC_SIDE_source: "in the reference",
  UI_SYNC_SIDE_target: "in the target",
  UI_SYNC_KIND_novo: "new field",
  UI_SYNC_COPY_DATA: { one: "Also copy the {n} record from the reference", other: "Also copy the {n} records from the reference" },
  UI_SYNC_COPY_NONE: "The reference table is empty — there is no data to copy.",
  UI_SYNC_COPY_WARN: "The data comes from the reference folder. Fine for lookup tables (banks, NCM, CFOP, cities); think twice if it is another customer's movement.",
  UI_SYNC_CREATE_EMPTY: "created empty",
  UI_SYNC_CREATE_WITH_DATA: { one: "created with {n} record copied", other: "created with {n} records copied" },
  UI_SYNC_WITH_DATA_COUNT: { one: "{n} with data", other: "{n} with data" },
  UI_SYNC_WITH_DATA_TITLE: "Will be created with the reference data",
  UI_SYNC_VIEW_DIFF: "differences only",
  UI_SYNC_VIEW_ALL: "all fields",
  UI_SYNC_VIEW_SAME: "the matching ones",
  UI_SYNC_VIEW_COUNT: "{n} of {total}",
  UI_SYNC_NO_FIELDS_IN_VIEW: "No field in this view.",
  UI_SYNC_FIELD_SAME: "matches",
  UI_SYNC_STATUS_same: "same",
  UI_SYNC_STATUS_differs: "differs",
  UI_SYNC_STATUS_missingInTarget: "does not exist",
  UI_SYNC_STATUS_onlyInTarget: "target only",
  UI_SYNC_STATUS_inUse: "in use",
  UI_SYNC_STATUS_invalid: "invalid",
  UI_SYNC_KIND_missing: "missing in target",
  UI_SYNC_KIND_extra: "target only",
  UI_SYNC_KIND_type: "different type",
  UI_SYNC_KIND_len: "different width",
  UI_SYNC_KIND_dec: "different decimals",
  UI_SYNC_KIND_position: "out of position",
  UI_SYNC_COL_POS: "No.",
  UI_SYNC_COL_FIELD: "Field",
  UI_SYNC_COL_REF: "Reference",
  UI_SYNC_COL_TARGET: "Target",
  UI_SYNC_COL_WHAT: "What differs",
  UI_SYNC_COL_CHOICE: "Decision",
  UI_SYNC_AUTO_CREATE: "will be created blank",
  UI_SYNC_AUTO_MOVE: "only moves",
  UI_SYNC_KEEP: "Ignore",
  UI_SYNC_ADOPT: "Update",
  UI_SYNC_DROP: "Remove",
  UI_SYNC_ALL_THIS_FILE: "in {file}:",
  UI_SYNC_ALL_FILES: "in every file:",
  UI_SYNC_BULK_DONE: { one: "{n} field decided.", other: "{n} fields decided." },
  UI_SYNC_BULK_DONE_ALL: { one: "{n} field decided across the whole list.", other: "{n} fields decided across the whole list." },
  UI_SYNC_BULK_NONE: "Nothing to decide here: no field asks for a choice — only order and new fields, which lose nothing.",
  UI_SYNC_SUMMARY: "{differs} to change · {create} to create · {same} same · {only} target only · {busy} in use/invalid",
  UI_SYNC_PENDING: { one: "{n} field without a decision", other: "{n} fields without a decision" },
  UI_SYNC_APPLY_ONE: "Apply this",
  UI_SYNC_APPLY_MARKED: { one: "Apply {n} marked", other: "Apply {n} marked" },
  UI_SYNC_APPLY_TITLE: "Apply the reference structure",
  UI_SYNC_APPLY_ASK: { one: "{n} target file will be changed or created with the reference structure. It is a separate operation with its own copy; data travels by field name.", other: "{n} target files will be changed or created with the reference structure. Each one is a separate operation with its own copy; data travels by field name." },
  UI_SYNC_APPLY_ASK_CREATE: { one: "{n} table will be created EMPTY in the target, with the reference structure. No existing file is touched.", other: "{n} tables will be created EMPTY in the target, with the reference structure. No existing file is touched." },
  UI_SYNC_APPLY_ASK_CREATE_DATA: { one: "{n} table will be created in the target with the reference structure. No existing file is touched; see below which ones carry the data too.", other: "{n} tables will be created in the target with the reference structure. No existing file is touched; see below which ones carry the data too." },
  UI_SYNC_APPLY_CONFIRM: "Apply",
  UI_SYNC_LOSS_shrink: "{field} shrinks — whatever does not fit is cut",
  UI_SYNC_LOSS_type: "{field} changes type — whatever does not convert is left empty",
  UI_SYNC_LOSS_dec: "{field} loses decimal places",
  UI_SYNC_LOSS_drop: "{field} is removed — that column's data is lost",
  UI_SYNC_WORKING: "applying to {file}…",
  UI_SYNC_STOPPING: "Stopping after the current file…",
  UI_SYNC_RESULT_TITLE: "Synchronization finished",
  UI_SYNC_RESULT_ok: "{file}: done",
  UI_SYNC_RESULT_fail: "{file}: failed — {detail}",
  UI_SYNC_RESULT_stop: "{file}: not run (stopped)",
  UI_SYNC_RESULT_skip: "{file}: nothing to do",
  INFO_SYNC_DONE: "Synchronization: {ok} done, {fail} failed.",
  WARN_SYNC_SKIPPED: "Skipped on request.",
  ERROR_SYNC_NEED_BOTH: "Choose the reference and the target.",
  ERROR_SYNC_SAME_DIR: "Reference and target are the same folder: {dir}",
  ERROR_SYNC_CHOICE_MISSING: "Field {field} has no decision yet (keep or adopt).",
  ERROR_SYNC_CHOICE_INVALID: "Invalid decision for {field}: {choice}.",
